...
class KindsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create kind' do
    assert_difference('Kind.count') do
      post kinds_url, params: { kind: { Kind: @kind.Kind, description: @kind.description } }, as: :json
    end
  ...
  test 'should update kind' do
    patch kind_url(@kind), params: { kind: { Kind: @kind.Kind, description: @kind.description } }, as: :json
    assert_response 200
  end
